...
const zh = {
  nav: { overview: "运营总览", projects: "项目资产", unclassified: "待分配内容", conversations: "对话底稿", summaries: "复盘总结", knowledge: "待审知识", activity: "入库流水", settings: "运行策略" },
  common: { openObsidian: "打开资产库", syncNow: "立即检查", more: "更多操作", refresh: "刷新数据", cancel: "取消", back: "返回", continue: "继续", browse: "选择目录", none: "暂无", path: "路径", status: "状态", settings: "运行策略", remove: "移除", add: "添加", close: "关闭", previous: "上一页", next: "下一页", page: "页", total: "共" },
  brand: "ChatGPT Codex × Obsidian",
  overview: {
    title: "内容资产运营台", subtitle: "监听 ChatGPT/Codex 项目对话，把可复用结论转成可审核、可追溯的运营资产",
    projects: "运营项目", projectsHint: "个项目已有内容资产", conversations: "对话底稿", conversationsHint: "包含已分配与待分配对话",
    candidates: "待分配内容", candidatesHint: "需要确认归属项目", conflicts: "待审核与冲突", conflictsNow: "项需要运营判断", noConflicts: "当前没有待审核项",
    recentProjects: "项目资产盘点", recentProjectsHint: "这里展示已经写入 Vault 的结果，不是监听来源", viewAll: "查看全部资产",
    projectName: "项目", sourcePath: "ChatGPT/Codex 工作目录", lastRead: "最近入库", content: "资产数", recentWrites: "最近资产变更", recentWritesHint: "按资产合并重复更新，不把同一个文件重复列出", updatedTimes: "次更新"
  },
  projects: { title: "项目资产", subtitle: "按工作目录隔离项目，运营复盘、知识与成果不串库", add: "配置项目", noSource: "由工作目录自动识别", empty: "还没有已归属的项目内容；请先处理“待分配内容”或配置项目目录。", conversation: "底稿", summary: "复盘", knowledge: "知识", output: "成果" },
  ...
  triage: { title: "待分配内容", subtitle: "这些对话已经安全入库，但尚未确认归属项目；分配后，整条对话及后续回合都会进入该项目", empty: "当前没有待分配内容", project: "归属项目", projectPlaceholder: "输入已有或新项目名称", assign: "归入项目", assigned: "内容已归入项目", source: "来源对话", storedAt: "临时存放位置" },
  ...
  activity: { title: "入库流水", subtitle: "记录内容何时被发现、更新、分配或审核，不重复保存对话正文", export: "导出流水", time: "处理时间", operation: "运营动作", type: "内容类型", target: "内容位置", result: "处理结果", transaction: "追踪编号" },
  operations: { upsert_thread_source: "新增或更新对话底稿", assign_project: "分配到项目", knowledge_validate: "采用知识", knowledge_archive: "不采用知识", knowledge_supersede: "淘汰旧知识", create: "新增内容", update: "更新内容" },
  settings: {
  ...
  inspector: { title: "资产概览", projectInspector: "项目资产概览", artifactInspector: "内容详情", vaultStructure: "内容目录", knowledgeStatus: "运营状态", sourceTask: "来源对话", recentTransaction: "最近追踪编号", open: "在 Obsidian 中打开", project: "项目", targetPath: "内容存放位置", sourceWorkspace: "来源项目目录" },
  setup: {
    vaultTitle: "连接你的 Obsidian Vault", vaultDescription: "所有内容只写入你选择的本地 Vault，应用不会上传对话正文。", vaultPlaceholder: "选择 Vault 文件夹",
    languageTitle: "选择目录与界面语言", languageDescription: "界面与项目结构会保持纯中文或纯英文，之后可以安全迁移。", chineseLayout: "项目 / 对话底稿 / 复盘总结 / 知识库", englishLayout: "Projects / Source Records / Operating Reviews / Knowledge",
  ...
  types: { conversation: "对话底稿", source: "对话底稿", learning_summary: "复盘总结", knowledge: "知识", prompt: "提示词", output: "输出成果", decision: "决策" }
};

type Localized<T> = { [K in keyof T]: T[K] extends string ? string : Localized<T[K]> };

const en: Localized<typeof zh> = {
  nav: { overview: "Operations", projects: "Project assets", unclassified: "Needs assignment", conversations: "Source records", summaries: "Reviews", knowledge: "Knowledge review", activity: "Intake log", settings: "Run policy" },
  common: { openObsidian: "Open asset vault", syncNow: "Check now", more: "More actions", refresh: "Refresh data", cancel: "Cancel", back: "Back", continue: "Continue", browse: "Choose folder", none: "None", path: "Path", status: "Status", settings: "Run policy", remove: "Remove", add: "Add", close: "Close", previous: "Previous", next: "Next", page: "Page", total: "Total" },
  brand: "ChatGPT Codex × Obsidian",
  overview: {
    ...
    projects: "Operating projects", projectsHint: "projects contain stored assets", conversations: "Source records", conversationsHint: "assigned and unassigned conversations",
    candidates: "Needs assignment", candidatesHint: "project ownership must be confirmed", conflicts: "Review and conflicts", conflictsNow: "items need an operator decision", noConflicts: "No review items",
    ...
    projectName: "Project", sourcePath: "ChatGPT/Codex workspace", lastRead: "Last intake", content: "Assets", recentWrites: "Recent asset changes", recentWritesHint: "Repeated writes to the same asset are combined", updatedTimes: "updates"
  },
  projects: { title: "Project assets", subtitle: "Keep reviews, knowledge, and outputs isolated by workspace", add: "Configure project", noSource: "Detected from workspace", empty: "No content has been assigned to a project yet. Process Needs assignment or configure a project folder.", conversation: "Sources", summary: "Reviews", knowledge: "Knowledge", output: "Outputs" },
  ...
  triage: { title: "Needs assignment", subtitle: "These conversations are safely stored but have no confirmed project. Assignment applies to the whole conversation and future turns.", empty: "Nothing needs assignment", project: "Destination project", projectPlaceholder: "Enter an existing or new project", assign: "Assign to project", assigned: "Content assigned", source: "Source conversation", storedAt: "Temporary storage" },
  ...
  activity: { title: "Intake log", subtitle: "Track when content was detected, updated, assigned, or reviewed without copying conversation text", export: "Export log", time: "Processed at", operation: "Operator action", type: "Content type", target: "Content location", result: "Result", transaction: "Trace ID" },
  operations: { upsert_thread_source: "Create or update source record", assign_project: "Assign to project", knowledge_validate: "Adopt knowledge", knowledge_archive: "Reject knowledge", knowledge_supersede: "Retire old knowledge", create: "Create content", update: "Update content" },
  settings: {
  ...
  inspector: { title: "Asset overview", projectInspector: "Project asset overview", artifactInspector: "Content details", vaultStructure: "Content folders", knowledgeStatus: "Operating status", sourceTask: "Source conversation", recentTransaction: "Latest trace ID", open: "Open in Obsidian", project: "Project", targetPath: "Content location", sourceWorkspace: "Source project folder" },
  setup: {
    ...
    languageTitle: "Choose folder and interface language", languageDescription: "The interface and project structure stay fully Chinese or fully English and can be migrated later.", chineseLayout: "项目 / 对话底稿 / 复盘总结 / 知识库", englishLayout: "Projects / Source Records / Operating Reviews / Knowledge",
  ...
  monitor: { title: "ChatGPT/Codex Monitor", subtitle: "Project conversations are the source; the Vault is only the destination", waiting: "Waiting for new turns", scanning: "Checking recent tasks", queue: "Pending", writeOne: "Store this turn", writeUnsorted: "Store as needs assignment", writeAll: "Store all", ignore: "Ignore this turn", details: "View intake plan", project: "Detected project", routeNeeded: "Project assignment needed", routeHint: "No trustworthy project mapping was found. After intake, this will appear under Needs assignment and will not be mixed into another project.", workspace: "Source workspace", detected: "New turn detected", started: "Monitoring started", noNew: "No new content in this check", wrote: "Intake complete", ignored: "Ignored and will not reappear", error: "Monitoring error", sourceOnly: "Source record only" },
  ...
  types: { conversation: "Source record", source: "Source record", learning_summary: "Operating review", knowledge: "Knowledge", prompt: "Prompt", output: "Output", decision: "Decision" }
};
