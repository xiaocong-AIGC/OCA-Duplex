...
export const mockOverview: OverviewData = {
  ...
  artifacts: [
    { path: "项目/OCA-Duplex/复盘总结/架构决策.md", title: "架构决策与实现进度", type: "learning_summary", status: "active", project: "OCA-Duplex", sourceThreadId: "019f4ab6", sourceTurnId: "turn-1", knowledgeOperation: null, updatedAt: "1 分钟前" },
    ...
    { path: "项目/OCA-Duplex/对话底稿/系统设计.md", title: "系统设计与桌面应用", type: "conversation", status: "captured", project: "OCA-Duplex", sourceThreadId: "019f4ab6", sourceTurnId: "turn-1", knowledgeOperation: null, updatedAt: "2 分钟前" }
  ],
  activity: [
    { eventId: "e1", occurredAt: "09:21", operation: "upsert_learning_summary", artifactType: "learning_summary", target: "项目/OCA-Duplex/复盘总结/架构决策.md", outcome: "updated", projectRoot: "项目/OCA-Duplex", transactionId: "tx-8f21", knowledgeOperation: null },
