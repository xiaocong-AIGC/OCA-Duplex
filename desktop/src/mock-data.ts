...
export const mockOverview: OverviewData = {
  ...
  artifacts: [
    { path: "项目/OCA-Duplex/学习总结/架构决策.md", title: "架构决策与实现进度", type: "learning_summary", status: "active", project: "OCA-Duplex", sourceThreadId: "019f4ab6", knowledgeOperation: null, updatedAt: "1 分钟前" },
    { path: "项目/OCA-Duplex/知识库/目录语言迁移规则.md", title: "目录语言迁移规则", type: "knowledge", status: "candidate", project: "OCA-Duplex", sourceThreadId: "019f4ab6", knowledgeOperation: "add", updatedAt: "2 分钟前" },
    { path: "项目/OCA-Duplex/原始对话/系统设计.md", title: "系统设计与桌面应用", type: "conversation", status: "captured", project: "OCA-Duplex", sourceThreadId: "019f4ab6", knowledgeOperation: null, updatedAt: "2 分钟前" }
  ],
  activity: [
